...
<main
  class="h-screen w-screen bg-[#f5f5f5] text-[#1b1b1b] font-sans flex flex-col p-8 select-none"
  on:contextmenu|preventDefault
>

  <div class="mb-6 bg-[#fcfcfc] p-5 rounded-lg">
    <label
      for="preset-select"
  ...
  <div class="mt-6 flex justify-end items-center gap-3">
    {#if files.length > 0}
      ...
      <button
        class="px-4 py-2 text-sm border-1 border-[#dfdfdf] border-b-[#eaeaea] text-[#1b1b1b] bg-[#ffffff] hover:bg-[#f5f5f5] active:bg-[#eeeeee] rounded-md transition-all disabled:opacity-50"
        disabled={processing}
        on:click={clearFiles}
      >
        全部清除
    ...
    <button
      class="px-8 py-2 bg-[#ffffff] border-1 border-[#dfdfdf] border-b-[#eaeaea] hover:bg-[#f0f0f0] active:bg-[#dedede] text-black text-sm font-medium rounded-md active:shadow-none disabled:bg-[#cccccc] 
       disabled:border-0 disabled:text-[#eeeeee] transition-all flex items-center gap-2"
